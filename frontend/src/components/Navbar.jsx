...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between py-5 font-medium">
     <Link to="/"> <img src={assets.logo} alt="Boldline Logo" className="w-36" /></Link>
      ...
      <div className='flex items-center gap-6'>
        ...
        <Link Link to="/cart" className='relative'>
      ...
      {/* Mobile Menu */}
      <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all duration-300 z-50 ${visible ? 'w-full shadow-lg' : 'w-0'}`}>
        ...
        <NavLink onClick={()=> setVisible(false)} className="py-2 pl-6 border  active:bg-black active:text-white" to="/">HOME</NavLink>
